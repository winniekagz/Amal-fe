                                ...
                                <CardHeader className="border-0">
                                    <div className="d-lg-flex align-items-center">
                                        <div className="flex-grow-1">
                                            <h5 className="card-title fw-bold mb-0">Live Auction</h5>
                                        </div>
                        ...
                        <Col xxl={3}>
                            <Card>
                                <CardHeader className="d-flex align-items-center">
                                    <h6 className="card-title fw-bold mb-0 flex-grow-1">Top Drop</h6>
                            ...
                            <Card>
                                <CardHeader className="d-flex align-items-center">
                                    <h6 className="card-title mb-0 fw-bold flex-grow-1">Top Creator</h6>
