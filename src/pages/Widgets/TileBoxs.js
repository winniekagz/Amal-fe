                        ...
                        <Card className={"card-animate " + item.bgColor}>
                            <CardBody>
                                ...
                                <div className="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 className={"fs-22 fw-bold ff-secondary mb-4 " + item.counterClass}><span className="counter-value" data-target="559.25">
                                            <CountUp
                                                start={0}
                                                prefix={item.prefix}
                                                suffix={item.suffix}
                            ...
                            <Row className="row-cols-md-3 row-cols-1">
                                ...
                                <Col className={item.id === 4 ? "col-lg" : "col-lg border-end"} key={key}>
                                    <div className="mt-3 mt-md-0 py-4 px-3">
                                        <h5 className="text-muted text-uppercase fs-14">{item.label} <i className={"fs-18 float-end align-middle " + item.badge}></i></h5>
                                        <div className="d-flex align-items-center">
                                            <div className="flex-shrink-0">
                    ...
                    <Card className={"card-animate " + item.bgColor}>
                        <CardBody>
                            <div className="d-flex justify-content-between">
                                <div>
                                    <p className={"fw-semibold mb-0 text-" + item.labelClass}>{item.label}</p>
                                    <h2 className={"mt-4 ff-secondary fw-bold " + item.counterClass}>
